...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix='/scratch/medfm/medfm-challenge/data/MedFMC_train/chest/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                backend='pillow',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/swinv2_bs8_lr0.05_exp1_'
