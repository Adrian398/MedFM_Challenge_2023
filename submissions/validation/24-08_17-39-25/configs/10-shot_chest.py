...
resume = False
run_name = 'vit-b_10-shot_ptokens-1_chest_baseline_test'
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/exp_2/vit-b_10-shot_ptokens-1_chest_baseline_test'
