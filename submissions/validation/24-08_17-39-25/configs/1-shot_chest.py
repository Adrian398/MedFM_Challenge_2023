...
resume = False
run_name = 'vit-b_1-shot_ptokens-1_chest_baseline_test'
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/exp_2/vit-b_1-shot_ptokens-1_chest_baseline_test'
