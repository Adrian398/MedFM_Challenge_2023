...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/densenet121_bs8_lr0.005_exp1_seed_search20230914-034957/best_multi-label_mAP_epoch_1000.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'densenet121_bs8_lr0.005_exp1_seed_search'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/densenet121_bs8_lr0.005_exp1_seed_search20230914-034957'
