...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/densenet121_bs8_lr0.005_exp3_seed_search20230914-080921/best_multi-label_mAP_epoch_800.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/densenet121_bs8_lr0.005_exp3_seed_search20230914-080921'
