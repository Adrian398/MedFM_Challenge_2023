...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/resnet101_bs16_lr1e-06e-06_exp5__exp+seed_test_20230901-033235/best_Aggregate_epoch_240.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    backbone=dict(
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/resnet101_bs16_lr1e-06e-06_exp5__exp+seed_test_20230901-033235'
