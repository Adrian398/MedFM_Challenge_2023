...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/clip-b_1_bs4_lr0.001_5-shot_chest_exp1_ensemble_soup_test20230904-182534/best_multi-label_mAP_epoch_158.pth'
log_level = 'INFO'
lr = 0.001
model = dict(
    backbone=dict(
...
resume = False
run_name = 'clip-b_1_bs4_lr0.001_5-shot_chest_exp1_ensemble_soup_test'
seed = 2049
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/clip-b_1_bs4_lr0.001_5-shot_chest_exp1_ensemble_soup_test20230904-182534'
