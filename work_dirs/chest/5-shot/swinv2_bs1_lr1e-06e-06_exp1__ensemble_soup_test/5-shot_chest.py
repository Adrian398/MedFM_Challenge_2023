...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/swinv2_bs1_lr1e-06e-06_exp1__ensemble_soup_test/best_Aggregate_epoch_180.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2_bs1_lr1e-06e-06_exp1__ensemble_soup_test'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/swinv2_bs1_lr1e-06e-06_exp1__ensemble_soup_test'
