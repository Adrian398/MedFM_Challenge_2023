...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/resnet101_bs4_lr1e-06e-06_exp1__ensemble_soup_test/best_Aggregate_epoch_225.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    backbone=dict(
...
resume = False
run_name = 'resnet101_bs4_lr1e-06e-06_exp1__ensemble_soup_test'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/5-shot/resnet101_bs4_lr1e-06e-06_exp1__ensemble_soup_test'
