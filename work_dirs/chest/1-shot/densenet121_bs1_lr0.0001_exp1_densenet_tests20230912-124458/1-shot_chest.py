...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs1_lr0.0001_exp1_densenet_tests20230912-124458/best_Aggregate_epoch_450.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'densenet121_bs1_lr0.0001_exp1_densenet_tests'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs1_lr0.0001_exp1_densenet_tests20230912-124458'
