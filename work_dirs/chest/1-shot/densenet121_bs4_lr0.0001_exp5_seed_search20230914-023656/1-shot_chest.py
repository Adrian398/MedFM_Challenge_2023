...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs4_lr0.0001_exp5_seed_search20230914-023656/best_Aggregate_epoch_125.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'densenet121_bs4_lr0.0001_exp1_seed_search'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs4_lr0.0001_exp5_seed_search20230914-023656'
