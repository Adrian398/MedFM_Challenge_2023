...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2_bs4_lr1e-06_exp1_swinv2_tests20230912-114429/best_Aggregate_epoch_475.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2_bs4_lr1e-06_exp1_swinv2_tests'
seed = 2049
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2_bs4_lr1e-06_exp1_swinv2_tests20230912-114429'
