...
resume = False
run_name = 'clip-b_1_bs4_lr0.001_1-shot_chest_baseline_test'
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/clip-b_1_bs4_lr0.001_1-shot_chest_baseline_test'
