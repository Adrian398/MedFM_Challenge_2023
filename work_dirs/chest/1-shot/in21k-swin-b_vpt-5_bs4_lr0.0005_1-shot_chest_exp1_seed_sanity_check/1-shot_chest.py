...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/in21k-swin-b_vpt-5_bs4_lr0.0005_1-shot_chest_exp1_seed_sanity_check/best_Aggregate_epoch_150.pth'
log_level = 'INFO'
lr = 0.0005
model = dict(
    backbone=dict(
...
randomness = dict(deterministic=False, seed=2049)
resume = False
run_name = 'in21k-swin-b_vpt-5_bs4_lr0.0005_1-shot_chest_exp1_seed_sanity_check'
seed = 2049
test_cfg = dict()
...
vpl = 5
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/in21k-swin-b_vpt-5_bs4_lr0.0005_1-shot_chest_exp1_seed_sanity_check'
