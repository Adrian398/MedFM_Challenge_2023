...
exp_num = 21
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/clip-b_1_bs4_lr0.001_1-shot_chest_exp1_seed_sanity_check/best_multi-label_mAP_epoch_62.pth'
log_level = 'INFO'
lr = 0.001
model = dict(
    backbone=dict(
...
resume = False
run_name = 'clip-b_1_bs4_lr0.001_1-shot_chest_exp21_seed_sanity_check'
seed = 2049
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/clip-b_1_bs4_lr0.001_1-shot_chest_exp1_seed_sanity_check'
