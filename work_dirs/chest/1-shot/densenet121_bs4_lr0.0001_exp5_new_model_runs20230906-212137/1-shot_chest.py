...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs4_lr0.0001_exp5_new_model_runs20230906-212137/best_Aggregate_epoch_275.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'densenet121_bs4_lr0.0001_exp1_new_model_runs'
test_cfg = dict()
...
train_pipeline = [
    ...
    dict(crop_ratio_range=(
        0.7,
        1.0,
    ), scale=256, type='RandomResizedCrop'),
    dict(direction='horizontal', prob=0.5, type='RandomFlip'),
    dict(direction='vertical', prob=0.5, type='RandomFlip'),
    dict(type='PackInputs'),
]
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs4_lr0.0001_exp5_new_model_runs20230906-212137'
