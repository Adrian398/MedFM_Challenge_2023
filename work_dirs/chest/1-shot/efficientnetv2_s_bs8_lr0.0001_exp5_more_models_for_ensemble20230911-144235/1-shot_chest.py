...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/efficientnetv2_s_bs8_lr0.0001_exp5_more_models_for_ensemble20230911-144235/best_Aggregate_epoch_450.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data_anns/MedFMC/chest/chest_1-shot_train_exp5.txt',
        data_prefix=
        '/scratch/medfm/medfm-challenge/data/MedFMC_train/chest/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data_anns/MedFMC/chest/chest_1-shot_val_exp5.txt',
        data_prefix=
        '/scratch/medfm/medfm-challenge/data/MedFMC_train/chest/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/efficientnetv2_s_bs8_lr0.0001_exp5_more_models_for_ensemble20230911-144235'
