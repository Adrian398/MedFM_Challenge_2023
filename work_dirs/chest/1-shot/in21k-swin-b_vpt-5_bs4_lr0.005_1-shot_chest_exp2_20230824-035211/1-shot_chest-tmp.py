...
exp_num = 2
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/in21k-swin-b_vpt-5_bs4_lr0.005_1-shot_chest_exp2_20230824-035211/best_Aggregate_epoch_380.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    backbone=dict(
...
vpl = 5
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/in21k-swin-b_vpt-5_bs4_lr0.005_1-shot_chest_exp2_20230824-035211'
