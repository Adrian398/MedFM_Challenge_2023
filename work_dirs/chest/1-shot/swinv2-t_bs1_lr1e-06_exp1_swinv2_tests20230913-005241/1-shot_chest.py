...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2-t_bs1_lr1e-06_exp1_swinv2_tests20230913-005241/best_Aggregate_epoch_110.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2-t_bs1_lr1e-06_exp1_swinv2_tests'
seed = 2049
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2-t_bs1_lr1e-06_exp1_swinv2_tests20230913-005241'
