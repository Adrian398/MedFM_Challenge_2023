...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs2_lr0.0001_exp1_densenet_tests20230912-122017/best_Aggregate_epoch_425.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/densenet121_bs2_lr0.0001_exp1_densenet_tests20230912-122017'
