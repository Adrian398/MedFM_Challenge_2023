...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2_bs8_lr1e-06e-06_exp1__seed_sanity_check/best_Aggregate_epoch_200.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2_bs8_lr1e-06e-06_exp1__seed_sanity_check'
seed = 2049
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/1-shot/swinv2_bs8_lr1e-06e-06_exp1__seed_sanity_check'
