...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/efficientnetv2_m_bs8_lr0.0001_exp5_more_models_for_ensemble20230911-220713/best_Aggregate_epoch_375.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/efficientnetv2_m_bs8_lr0.0001_exp5_more_models_for_ensemble20230911-220713'
