...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs4_lr0.005_exp5_seed_120230913-161725/best_multi-label_mAP_epoch_975.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'densenet121_bs4_lr0.005_exp1_seed_1'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs4_lr0.005_exp5_seed_120230913-161725'
