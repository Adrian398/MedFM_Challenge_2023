...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/efficientnetv2_s_bs8_lr0.0001_exp2_more_models_for_ensemble20230911-170511/best_Aggregate_epoch_250.pth'
log_level = 'INFO'
lr = 0.0001
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/efficientnetv2_s_bs8_lr0.0001_exp2_more_models_for_ensemble20230911-170511'
