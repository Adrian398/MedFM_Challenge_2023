...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/swinv2_bs2_lr1e-06_exp5_swinv2_btl_seed320230913-163229/best_Aggregate_epoch_100.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2_bs2_lr1e-06_exp1_swinv2_btl_seed3'
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/swinv2_bs2_lr1e-06_exp5_swinv2_btl_seed320230913-163229'
