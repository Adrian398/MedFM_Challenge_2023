...
exp_num = 2
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/eva02-b_1_bs4_lr0.001_10-shot_chest_exp1_baseline_test/best_multi-label_mAP_epoch_173.pth'
log_level = 'INFO'
lr = 0.001
model = dict(
    backbone=dict(
...
resume = False
run_name = 'eva02-b_1_bs4_lr0.001_10-shot_chest_exp2_baseline_test'
test_cfg = dict()
...
vpl = 1
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/eva02-b_1_bs4_lr0.001_10-shot_chest_exp1_baseline_test'
