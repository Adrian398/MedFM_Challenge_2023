...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs4_lr0.005_exp2_seed_120230913-143456/best_multi-label_mAP_epoch_700.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs4_lr0.005_exp2_seed_120230913-143456'
