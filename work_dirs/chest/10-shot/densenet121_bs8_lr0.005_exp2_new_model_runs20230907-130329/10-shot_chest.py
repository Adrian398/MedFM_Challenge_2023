...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs8_lr0.005_exp2_new_model_runs20230907-130329/best_multi-label_mAP_epoch_950.pth'
log_level = 'INFO'
lr = 0.005
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/densenet121_bs8_lr0.005_exp2_new_model_runs20230907-130329'
