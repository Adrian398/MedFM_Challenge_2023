...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/swinv2-t_bs2_lr1e-06_exp3_seed_search20230914-103036/best_Aggregate_epoch_460.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    _scope_='mmpretrain',
...
resume = False
run_name = 'swinv2-t_bs2_lr1e-06_exp1_seed_search'
seed = 2049
test_cfg = dict()
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/chest/10-shot/swinv2-t_bs2_lr1e-06_exp3_seed_search20230914-103036'
