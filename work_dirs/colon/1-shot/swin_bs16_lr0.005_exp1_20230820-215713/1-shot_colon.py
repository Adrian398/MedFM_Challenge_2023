...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        norm_decay_mult=0.0))
param_scheduler = [
    dict(by_epoch=False, end=50, start_factor=0.001, type='LinearLR'),
    dict(begin=50, by_epoch=False, eta_min=1e-05, type='CosineAnnealingLR'),
]
...
vpl = 5
warmup_lr = 0.001
work_dir = 'work_dirs/colon/1-shot/swin_bs16_lr0.005_exp1_20230820-215713'
