...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/colon/1-shot/swin_bs8_lr0.05_exp1_20230820-130916/best_multi-label_mAP_epoch_625.pth'
log_level = 'INFO'
lr = 0.05
model = dict(
    backbone=dict(
...
resume = False
run_name = 'swin_bs8_lr0.05_exp1_'
test_cfg = dict()
...
train_bs = 8
train_cfg = dict(by_epoch=True, max_epochs=1500, val_interval=125)
...
vpl = 5
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/colon/1-shot/swin_bs8_lr0.05_exp1_20230820-130916'
