...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        norm_decay_mult=0.0))
param_scheduler = [
    dict(by_epoch=True, end=10, start_factor=0.001, type='LinearLR'),
    dict(begin=10, by_epoch=True, eta_min=1e-05, type='CosineAnnealingLR'),
]
randomness = dict(deterministic=False, seed=None)
resume = False
run_name = 'swin_bs4_lr0.0005_exp1_'
test_cfg = dict()
...
vpl = 5
warmup_lr = 0.001
work_dir = 'work_dirs/colon/1-shot/swin_bs4_lr0.0005_exp1_20230821-001759'
