...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/colon/10-shot/swinv2_bs8_lr0.05_exp1_20230822-002310/best_multi-label_mAP_epoch_20.pth'
log_level = 'INFO'
lr = 0.05
model = dict(
    _scope_='mmpretrain',
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/colon/10-shot/swinv2_bs8_lr0.05_exp1_20230822-002310'
