...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/endo/5-shot/resnet101_bs32_lr5e-06e-06_exp5__exp+seed_test_20230831-225231/best_Aggregate_epoch_210.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    backbone=dict(
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/endo/5-shot/resnet101_bs32_lr5e-06e-06_exp5__exp+seed_test_20230831-225231'
