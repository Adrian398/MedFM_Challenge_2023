...
exp_num = 1
launcher = 'none'
load_from = '/scratch/medfm/medfm-challenge/work_dirs/endo/5-shot/resnet101_bs32_lr5e-06e-06_exp2__exp+seed_test_20230831-213213/best_Aggregate_epoch_210.pth'
log_level = 'INFO'
lr = 1e-06
model = dict(
    backbone=dict(
...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data_anns/MedFMC/endo/endo_5-shot_train_exp2.txt',
        data_prefix=
        '/scratch/medfm/medfm-challenge/data/MedFMC_train/endo/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data_anns/MedFMC/endo/endo_5-shot_val_exp2.txt',
        data_prefix=
        '/scratch/medfm/medfm-challenge/data/MedFMC_train/endo/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = '/scratch/medfm/medfm-challenge/work_dirs/endo/5-shot/resnet101_bs32_lr5e-06e-06_exp2__exp+seed_test_20230831-213213'
